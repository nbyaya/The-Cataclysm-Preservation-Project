...
DELETE FROM `phase_area` WHERE `AreaId`=4714 AND `PhaseId`=184;
DELETE FROM `phase_area` WHERE `AreaId`=4814 AND `PhaseId`=184;
INSERT INTO `phase_area` (`AreaId`, `PhaseId`, `Comment`) VALUES (4714, 184, 'need conditions');
INSERT INTO `phase_area` (`AreaId`, `PhaseId`, `Comment`) VALUES (4814, 184, 'need conditions');